...
function DetailPitch({ landId }) {
  ...
  const fetchSummary = async () => {
    try {
      const bookingNumberResponse =
        await DashboardApi.GetSummaryBookingByLandId(landId);
      const revenueResponse = await DashboardApi.GetSummaryProfitByLandId(
        landId
      );
      const pitchNumberResponse = await DashboardApi.GetSummarypitchByLandId(
        landId
      );
      const summaryByMonthResponse =
        await DashboardApi.GetSummaryByMonthAndLandId(
