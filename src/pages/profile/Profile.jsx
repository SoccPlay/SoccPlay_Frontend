        ...
        <Grid item xs={12} sx={{}}>
          ...
          >
            <TabList item container mt={"60px"} sx={{}}>
              <Tab item container alignItems={"center"} xs={17} color={"#FFF"}>
              ...
              <Tab item container alignItems={"center"} xs={12} color={"#FFF"}>
                <NotificationsNoneIcon sx={{ mr: "20px", color: "white" }} />
                <Typography
                  fontSize={"28px"}
                  fontWeight={"bold"}
                  color={"#FFF"}
              ...
              >
                <VpnKeyIcon sx={{ mr: "20px", color: "white" }} />
                <Typography
                  fontSize={"28px"}
                  fontWeight={"bold"}
                  color={"#FFF"}
